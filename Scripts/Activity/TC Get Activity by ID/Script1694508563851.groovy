...
response = WS.sendRequest(findTestObject('Object Repository/Actvity/Get Activity by ID'))

WS.verifyResponseStatusCode(response, 200)

id = WS.getElementPropertyValue(response, "id");
title = WS.getElementPropertyValue(response, "title");
dueDate = WS.getElementPropertyValue(response, "dueDate");
completed = WS.getElementPropertyValue(response, "completed");
