...
response = WS.sendRequest(findTestObject('Object Repository/Book/Get Book by ID'))

WS.verifyResponseStatusCode(response, 200)

id = WS.getElementPropertyValue(response, "id");
title = WS.getElementPropertyValue(response, "title");
description = WS.getElementPropertyValue(response, "description");
pageCount = WS.getElementPropertyValue(response, "pageCount");
excerpt = WS.getElementPropertyValue(response, "excerpt");
publishDate = WS.getElementPropertyValue(response, "publishDate");
